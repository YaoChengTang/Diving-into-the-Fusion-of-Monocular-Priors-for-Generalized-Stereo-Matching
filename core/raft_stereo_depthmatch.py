...
from core.extractor_depthany import DepthAnyExtractor, DepthMatchExtractor
...
class RAFTStereoDepthMatch(nn.Module):
    def __init__(self, args):
        super(RAFTStereoDepthMatch, self).__init__()
        self.args = args
        ...
        if args.shared_backbone:
            ...
            self.fnet = DepthMatchExtractor(model_dir=args.depthany_model_dir,
                                            output_dim=256, 
                                            norm_fn='instance', 
                                            downsample=args.n_downsample)

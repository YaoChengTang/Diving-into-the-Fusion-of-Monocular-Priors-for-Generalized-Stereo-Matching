...
# python3 -m torch.distributed.launch --master_port=20000 --nproc_per_node 8 train_stereo.py --batch_size 9 --num_workers 6 --train_iters 22 --valid_iters 32 --spatial_scale -0.2 0.4 --saturation_range 0 1.4 --n_downsample 2 --num_steps 30000 --mixed_precision --confidence --offset_memory_size 3 --offset_memory_last_iter 10 --detach_in_confidence --conf_disp --refinement "Refinement" --refine_win_size 10 10 --refine_start_itr 3 --update_his --U_thold 0.5 --num_heads 6 --enable_refine_step 3000

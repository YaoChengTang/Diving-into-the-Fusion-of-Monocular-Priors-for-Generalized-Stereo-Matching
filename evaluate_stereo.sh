...
# CUDA_VISIBLE_DEVICE=2 python3 evaluate_stereo.py --restore_ckpt pretrained/raft-stereo-PostGeo_slantlocal_mean-20231106-154407.pth --slant "slant_local" --slant_builder "geometry" --geo_fusion "mean" --dataset middlebury_H
# CUDA_VISIBLE_DEVICE=2 python3 evaluate_stereo.py --restore_ckpt pretrained/raft-stereo-PostGeo_slantlocal_mean-20231106-154407.pth --slant "slant_local" --slant_builder "geometry" --geo_fusion "mean" --dataset kitti
# CUDA_VISIBLE_DEVICE=2 python3 evaluate_stereo.py --restore_ckpt pretrained/raft-stereo-PostGeo_slantlocal_mean-20231106-154407.pth --slant "slant_local" --slant_builder "geometry" --geo_fusion "mean" --dataset eth3d

# CUDA_VISIBLE_DEVICE=2 python3 evaluate_stereo.py --restore_ckpt pretrained/raft-stereo-PostGeo_slant_norm_mean-20231106-160408.pth --slant "slant" --slant_builder "geometry" --geo_fusion "mean" --dataset middlebury_H

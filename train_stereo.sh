...
CUDA_VISIBLE_DEVICE=1,2 python train_stereo.py --batch_size 4 --train_iters 22 --valid_iters 32 --spatial_scale -0.2 0.4 --saturation_range 0 1.4 --n_downsample 2 --num_steps 200000 --mixed_precision

...
CUDA_VISIBLE_DEVICE=2 python3 gen_sample_stereo.py --restore_ckpt pretrained/raft-stereo-Refine2_detach_mask_Conf_loss-W10-B3-20231016-141357.pth --confidence --offset_memory_size 3 --detach_in_confidence --refinement "Refinement" --refine_win_size 10 --refine_start_itr 3 --dataset kitti --sv_root /home/users/chengtang.yao/Output/raftstereo-Refine2_detach_mask_Conf_loss --mask
CUDA_VISIBLE_DEVICE=2 python3 gen_sample_stereo.py --restore_ckpt pretrained/raft-stereo-Refine2_detach_mask_Conf_loss-W10-B3-20231016-141357.pth --confidence --offset_memory_size 3 --detach_in_confidence --refinement "Refinement" --refine_win_size 10 --refine_start_itr 3 --dataset eth3d --sv_root /home/users/chengtang.yao/Output/raftstereo-Refine2_detach_mask_Conf_loss --mask
